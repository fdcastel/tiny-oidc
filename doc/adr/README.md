...
| [0019](0019-audit-hot-table-capacity.md) | The audit hot table keeps a bounded subset of events (hot and archive classes per type, 14-day default retention, a CI capacity check); the archive is written per consumer batch — at the §2.7 rates every event in D1 fills the database in three days | Proposed |
