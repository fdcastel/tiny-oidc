...
// `backchannel_logout` retries run here (TIO-LOGOUT-012); the audit batches
// of TIO-AUDIT-011 arrive in Phase 6. A message the consumer cannot read is
// acknowledged and logged (nothing would change on redelivery); a failure of
// the OP's own infrastructure (keys, configuration) retries the message.
